...
QString Obrero::salarioBrutoTotal()
{
    QString str = "";
    double salB=0;
    salB+=this->m_salarioBruto;
    setSalarioBruto(salB);
    str.append(QString::number(salarioBruto()));
    return str;
}
QString Obrero::iessTotal()
{
    QString str = "";
    double salB=0;
    salB+=this->m_descuento;
    setDescuento(salB);
    str.append(QString::number(descuento()));
    return str;
}
QString Obrero::salarioNetoTotal()
{
    QString str = "";
    double salB=0;
    salB+=this->m_salarioNeto;
    setSalarioNeto(salB);
    str.append(QString::number(salarioNeto()));
    return str;
}
