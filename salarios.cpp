...
//void Salarios::calcular(double stProducto)
//{
//     m_sBruto += stProducto;
//     ui->outBrutoTotal->appendPlainText(m_controlador->obrero()->salarioBrutoTotal());
...
void Salarios::calcular()
{
    ...
    if (m_controlador->calcularSalario()){
        ...
        QMessageBox::critical(
            ...
            ui->outBrutoTotal->appendPlainText(m_controlador->obrero()->salarioBrutoTotal());
             ui->outIessTotal->appendPlainText(m_controlador->obrero()->iessTotal());
              ui->outNetoTotal->appendPlainText(m_controlador->obrero()->salarioNetoTotal());
}
